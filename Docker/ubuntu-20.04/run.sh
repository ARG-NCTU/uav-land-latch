...
CONTAINER_NAME="argrobotx-ubuntu-20.04"
...
docker run \
  ...
  -v "/home/$USER/robotx-2022/volume/.config:/home/${USER_NAME}/.config" \
  -v "/home/$USER/robotx-2022/rl/jax/acme_logs:/home/${USER_NAME}/acme" \
  --user "root:root" \
