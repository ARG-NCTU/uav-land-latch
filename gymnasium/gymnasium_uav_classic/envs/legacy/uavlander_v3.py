...
############################################################################################################
    ...
    def _get_reward(self, action, step):
        ...
        output = "\rstep:{:4d}, actions[{},{},{},{},{}], r:{:.2f}, h:{} hight_score:{} dist_rew:{}, radius_bonus{}, vz_punish:{} reward:{}, landing: {}".format(
            ...
            r,
            " {:.2f}".format(h) if self.uav_act[4] >= 0 else "{:.2f}".format(h),
            " {:.2f}".format(hight_score) if hight_score >= 0 else "{:.2f}".format(hight_score),
            " {:.2f}".format(dist_rew) if dist_rew >= 0 else "{:.2f}".format(dist_rew),
            " {:.2f}".format(radius_bonus) if radius_bonus >= 0 else "{:.2f}".format(radius_bonus),
            " {:.2f}".format(vz_punish) if vz_punish >= 0 else "{:.2f}".format(vz_punish),
